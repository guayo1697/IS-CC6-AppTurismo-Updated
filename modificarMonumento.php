...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-light-blue w3-card-2">
      ...
      <a href="Aerolineas.php" class="w3-bar-item w3-button w3-padding-large">Menú</a>
    </div>
  </div>
</div>
...
$nombrecentro = $fila3['nombre'];
      ...
      <br>
      <div>Extra
        <textarea class='w3-input w3-border' style='resize:none' name=Extra placeholder='Extra' value=$extra></textarea>
      </div>
      <br>
