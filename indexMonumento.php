...
<div class=w3-top>
  <div class=w3-bar w3-white w3-padding w3-card style=letter-spacing:4px;>
    <a href=#home class=w3-bar-item w3-button>App INGUAT</a>
    <!-- Right-sided navbar links. Hide them on small screens -->
    <div class=w3-right w3-hide-small>
      <a href=#historia class=w3-bar-item w3-button>Historia</a>
      <a href=#menu class=w3-bar-item w3-button>Arquitectura</a>
      <a href=#contact class=w3-bar-item w3-button>Conservacion</a>
    </div>
  </div>
</div>
...
<header class=w3-display-container w3-content w3-wide style=max-width:1600px;min-width:500px id=home>
  <img class=w3-image src=imagen2.jpg alt=Tikal width=1600 height=800>
