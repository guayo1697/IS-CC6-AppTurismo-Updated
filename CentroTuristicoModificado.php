...
/*Obtiene los datos de codigo(id_centro), nombre, direccion e id_dep de la pagina anterior que es modificarCentroTuristico.php estos datos se incluyen en un query que realiza el update en la base de datos*/
  $codigo = $_GET["Codigo"];
  $nombre = $_GET["Nombre"];
